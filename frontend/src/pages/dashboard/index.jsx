...
import { createPost, getAllPosts, deletePost, incrementPostLike, getAllComments, postComment  } from '@/config/redux/action/postAction';
                                ...
                                return (
                                    <div key={post._id} className={styles.singleCard}>
                                        ...
                                        <div className={styles.singleCard__profileContainer}>
                                            <img className={styles.userProfile} src={`${BASE_URL}/${post.userId.profilePicture}`} alt="userprofile" />
                                            <div>
                                                ...
                                                <div className={styles.singleCard__image}>
                                                    ...
                                                    {post.media !== "" ? <img src={`${BASE_URL}/${post.media}`} alt='image'/> : <></> }
